...
fun HowToScreen() {
    Column(
        ...
        Text(
            text = "Players build a chain of recipes by matching ingredients. Each round, the player is given a starting recipe and must find a next recipe that shares at least one key ingredient. The goal is to create the longest possible chain before either guessing incorrectly or running out of valid moves.",
            modifier = Modifier
                .align(Alignment.CenterHorizontally)
                .padding(16.dp)
        )
        ...
        Text(
            text = "- Start: “Easy chocolate cake” (main ingredients: chocolate, flour, egg)\n" +
